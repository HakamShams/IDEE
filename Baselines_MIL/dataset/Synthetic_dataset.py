...
class Synthetic_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return datacube_dynamic.copy(), datacube_static.copy(), datacube_t.copy(), \
               mask_extreme.copy(), mask_extreme_loss.copy(), mask_anomaly.copy(), datacube_tstep.copy()
...
if __name__ == '__main__':
    ...
    dataset = Synthetic_Dataset(
        ...
        is_aug=False, is_clima_scale=False, is_norm=False,
        variables=variables, variables_static=variables_static,
        times=times_val, window_size=1
    )
    ...
    if is_test_run:
        ...
        for i, (data_d, data_s, data_t,
                mask_extreme, mask_extreme_loss, mask_anomaly, d_ts) in enumerate(train_loader):
    ...
    if is_test_plot:
        ...
        for i in range(len(dataset)):
            ...
            data_d, data_s, data_t, data_extreme, data_extreme_loss, data_anomaly, data_ts = dataset[int(i)]
